...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.users.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add User</a>
    </div>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody class="text-gray-700">
                ...
                <tr>
                    ...
                    <td class="w-1/4 text-left py-3 px-4">{{ $user->role }}</td>
                    <td class="w-1/4 text-left py-3 px-4">{{ $user->created_at }}</td>
                    <td class="py-3 px-4">
