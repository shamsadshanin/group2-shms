...
<div class="px-4 py-6 sm:px-0">
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Oversee all patients and their records.</p>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No patients found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
